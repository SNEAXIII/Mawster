...
name: shadcn
description: >
  Add, search, fix, debug, style and compose shadcn/ui components, with project context and usage
  examples. Use for shadcn/ui work, component registries, `--preset` codes, any project with a
  `components.json`, or "shadcn init".
