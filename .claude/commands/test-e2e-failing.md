...
2. **Relancer** : appeler `mcp__cypress-runner__run_failing_tests` avec le paramètre `spec_files` = liste des chemins relatifs à `front/`. Ex : `["cypress/e2e/war/basic.cy.ts"]`.
