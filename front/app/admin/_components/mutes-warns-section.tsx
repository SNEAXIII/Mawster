  ...
  return (
    ...
    >
      ...
      <div className='overflow-x-auto rounded-md border border-border'>
        <table
          className='w-full min-w-160 table-fixed text-sm'
          data-cy='mutes-table'
        >
          <colgroup>
            <col className='w-[16%]' />
          ...
          <tbody>
            ...
            {mutes.map((mu) => (
              ...
              >
                ...
                <td
                  className='px-3 py-2 max-w-48 truncate'
                  title={mu.reason}
                >
                  {mu.reason}
                </td>
                ...
                <td className='px-3 py-2'>
                  <div className='flex items-center gap-2'>
                    <Button
                      ...
                      onClick={() =>
                        openDialog('warn', { userId: mu.user_id, userLogin: mu.user_login })
                      }
                    >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setLiftTarget({ userId: mu.user_id, userLogin: mu.user_login })
                      }
                    >
          ...
          <tbody>
            ...
            {warns.map((wa) => (
              ...
              >
                ...
                <td className='px-3 py-2 whitespace-nowrap'>
                  {new Date(wa.created_at).toLocaleString()}
                </td>
                ...
                <td className='px-3 py-2'>
                  <Button
                    ...
                    onClick={() =>
                      openDialog('mute', { userId: wa.user_id, userLogin: wa.user_login })
                    }
                  >
