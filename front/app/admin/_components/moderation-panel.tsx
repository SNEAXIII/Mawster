    ...
    >
      <div className='flex items-center gap-3'>
        ...
        >
          <SelectTrigger
            className='w-48'
            data-cy='moderation-status-filter'
          >
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className='overflow-x-auto rounded-md border border-border'>
        <table
          ...
          data-cy='moderation-reports-table'
        >
