      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <InfoRow icon={<User className="h-4 w-4" />} label={t.profile.username} value={user?.name} fallback={t.common.notAvailable} dataCy="username-row" />
            <InfoRow icon={<Mail className="h-4 w-4" />} label={t.profile.email} value={user?.email} fallback={t.common.notAvailable} dataCy="email-row" />
            ...
            <InfoRow icon={<Calendar className="h-4 w-4" />} label={t.profile.memberSince} value={user?.created_at ? formatDateLong(user.created_at, locale) : t.common.notAvailable} fallback={t.common.notAvailable} dataCy="member-since-row" />
          </div>
        </CardContent>
      </Card>
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50" data-cy={dataCy}>
