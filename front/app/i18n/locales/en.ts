const en = {
  ...
  game: {
    ...
    alliances: {
      ...
      members: 'members',
      adjoints: 'Deputies',
      addAdjoint: 'Add deputy',
      addAdjointButton: 'Add',
      removeAdjoint: 'Remove deputy',
      selectAdjoint: 'Select a game account',
      adjointAddSuccess: 'Deputy added successfully!',
      adjointAddError: 'Failed to add deputy',
      adjointRemoveSuccess: 'Deputy removed successfully!',
      adjointRemoveError: 'Failed to remove deputy',
