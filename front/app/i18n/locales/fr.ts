...
const fr: Translations = {
  ...
  game: {
    ...
    alliances: {
      ...
      members: 'membres',
      adjoints: 'Adjoints',
      addAdjoint: 'Ajouter un adjoint',
      addAdjointButton: 'Ajouter',
      removeAdjoint: 'Retirer l\'adjoint',
      selectAdjoint: 'Sélectionner un compte de jeu',
      adjointAddSuccess: 'Adjoint ajouté avec succès !',
      adjointAddError: "Erreur lors de l'ajout de l'adjoint",
      adjointRemoveSuccess: 'Adjoint retiré avec succès !',
