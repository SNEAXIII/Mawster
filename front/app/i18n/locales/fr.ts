...
const fr: Translations = {
  ...
  game: {
    ...
    alliances: {
      ...
      you: 'Vous',
      officers: 'Officiers',
      addOfficer: 'Ajouter un officer',
      addOfficerButton: 'Ajouter',
      removeOfficer: 'Retirer l\'officer',
      selectOfficer: 'Sélectionner un membre',
      promoteOfficerConfirm: 'Êtes-vous sûr de vouloir promouvoir {pseudo} en officier ?',
      officerAddSuccess: 'Officer ajouté avec succès !',
      officerAddError: "Erreur lors de l'ajout de l'officer",
      officerRemoveSuccess: 'Officer retiré avec succès !',
