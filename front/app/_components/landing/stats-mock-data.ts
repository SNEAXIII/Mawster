...
export const MOCK_SEASON_STATS: PlayerSeasonStats[] = [
  row('m1', 'CosmicGhost', 1, { kos: 0, fights: 40, weighted: 40, assists: 0, miniboss: 18, boss: 2, wars: 5, notFought: 0 }),
  row('m2', 'ThunderFist', 1, { kos: 0, fights: 26, weighted: 27, assists: 2, miniboss: 8, boss: 1, wars: 5, notFought: 0 }),
  row('m3', 'StormBreaker', 3, { kos: 1, fights: 50, weighted: 46, assists: 1, miniboss: 16, boss: 2, wars: 7, notFought: 0 }),
  row('m4', 'SteelNerve', 2, { kos: 1, fights: 50, weighted: 49, assists: 1, miniboss: 20, boss: 1, wars: 7, notFought: 1 }),
  row('m5', 'CrimsonWolf', 2, { kos: 1, fights: 34, weighted: 32, assists: 0, miniboss: 4, boss: 2, wars: 7, notFought: 0 }),
  row('m6', 'ShadowReaper', 1, { kos: 2, fights: 50, weighted: 43, assists: 2, miniboss: 14, boss: 2, wars: 7, notFought: 0 }),
  row('m7', 'VenomPulse', 1, { kos: 2, fights: 41, weighted: 41, assists: 3, miniboss: 12, boss: 1, wars: 7, notFought: 0 }),
  row('m8', 'IronVortex', 3, { kos: 2, fights: 40, weighted: 39, assists: 1, miniboss: 10, boss: 1, wars: 7, notFought: 0 }),
  row('m9', 'NightCrawler99', 3, { kos: 2, fights: 38, weighted: 36, assists: 0, miniboss: 6, boss: 0, wars: 6, notFought: 1 }),
  row('m10', 'BlazeRunner', 2, { kos: 3, fights: 50, weighted: 45, assists: 4, miniboss: 9, boss: 1, wars: 7, notFought: 1 }),
  row('m11', 'FrostByte', 1, { kos: 3, fights: 45, weighted: 42, assists: 0, miniboss: 7, boss: 0, wars: 7, notFought: 0 }),
  row('m12', 'NovaPrime', 3, { kos: 3, fights: 42, weighted: 39, assists: 2, miniboss: 5, boss: 1, wars: 6, notFought: 1 }),
  row('m13', 'RogueSignal', 1, { kos: 3, fights: 36, weighted: 33, assists: 0, miniboss: 6, boss: 1, wars: 6, notFought: 1 }),
  row('m14', 'TitanForce', 2, { kos: 4, fights: 42, weighted: 35, assists: 1, miniboss: 3, boss: 0, wars: 6, notFought: 2 }),
  row('m15', 'GhostProtocol', 2, { kos: 5, fights: 48, weighted: 40, assists: 1, miniboss: 4, boss: 0, wars: 7, notFought: 2 }),
  row('m16', 'ApexHunter', 3, { kos: 6, fights: 48, weighted: 40, assists: 1, miniboss: 3, boss: 0, wars: 6, notFought: 3 }),
  row('m17', 'EchoStrike', 2, { kos: 4, fights: 25, weighted: 22, assists: 0, miniboss: 4, boss: 0, wars: 5, notFought: 2 }),
  row('m18', 'LunarFang', 1, { kos: 7, fights: 30, weighted: 26, assists: 0, miniboss: 2, boss: 0, wars: 5, notFought: 4 }),
];
