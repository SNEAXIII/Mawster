...
Revision ID: 593c3eb26523
Revises: f4eb8c81064b
Create Date: 2026-04-05 02:35:39.211318
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('war_id', 'battlegroup', 'champion_user_id', name='uq_war_prefight_champion')
    )
