...
down_revision: str | None = "845077a610bf"
...
def upgrade() -> None:
    op.add_column(
        ...
        sa.Column("is_fight_not_done", sa.Boolean(), nullable=False, server_default=sa.false()),
    )
    op.add_column(
        "war_defense_placement",
        sa.Column("is_planning_error", sa.Boolean(), nullable=False, server_default=sa.false()),
    )
    op.add_column(
        "war_fight_record",
        sa.Column("is_planning_error", sa.Boolean(), nullable=False, server_default=sa.false()),
