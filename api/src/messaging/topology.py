...
async def declare_topology(channel: AbstractChannel) -> AbstractExchange:
    ...
    # These arguments are immutable once the queue exists: any change makes RabbitMQ
    # answer PRECONDITION_FAILED (406) and close the channel for every connecting
    # process. See docs/adr/0013-queue-arguments-are-immutable-once-declared.md.
