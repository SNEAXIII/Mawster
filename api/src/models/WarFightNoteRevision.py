...
class WarFightNoteRevision(UUIDBase, table=True):
    ...
    edited_by_game_account_id: uuid.UUID | None = Field(default=None, foreign_key="game_account.id")
    edited_by_user_id: uuid.UUID | None = Field(default=None, foreign_key="user.id")
