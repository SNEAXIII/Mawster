...
DISCORD_TOKEN_INVALID_EXCEPTION = HTTPException(status.HTTP_401_UNAUTHORIZED, DISCORD_TOKEN_INVALID)

DISCORD_API_ERROR_EXCEPTION = HTTPException(status.HTTP_502_BAD_GATEWAY, DISCORD_API_ERROR)

DISCORD_TOKEN_FOREIGN_APP_EXCEPTION = HTTPException(
    status.HTTP_401_UNAUTHORIZED, DISCORD_TOKEN_FOREIGN_APP
)
